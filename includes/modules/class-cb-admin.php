...
final class CB_Admin {
    ...
    public static function register_menu(): void {
        ...
        if(is_admin() && ($has_cb_admin_role || $has_cb_support_role || $is_admin)) {
            ...
            // Optionally, you could add a notice here for users who try to access the menu without proper roles
             add_action('admin_notices', function() {
                echo '<div class="notice notice-error"><p>' . __('You do not have permission to access the Calendly Bookings admin pages.', 'calendly-bookings') . '</p></div>';
            });
        }
    }
