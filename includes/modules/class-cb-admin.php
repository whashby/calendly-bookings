...
final class CB_Admin {
    ...
    public static function init(): void {
        CB_Audit_Log::log('method_entry', 'admin', __METHOD__, [], 'info');
        try {
            add_action('admin_menu', [__CLASS__, 'register_menu']);
            add_action('admin_enqueue_scripts', [__CLASS__, 'enqueue_assets']);
            add_action('admin_notices', [__CLASS__, 'show_admin_notices']);
            CB_Audit_Log::log('method_exit', 'admin', __METHOD__, [], 'info');
        } catch (\Throwable $e) {
            CB_Audit_Log::log('error', 'admin', __METHOD__, ['error' => $e->getMessage()], 'error');
        }
    }
    ...
    public static function enqueue_assets(string $hook): void {
        CB_Audit_Log::log('method_entry', 'admin', __METHOD__, ['hook' => $hook], 'info');
        try {
            ...
            CB_Audit_Log::log('error', 'admin', __METHOD__, ['error' => $e->getMessage(), 'hook' => $hook], 'error');
        }
    }
    /**
